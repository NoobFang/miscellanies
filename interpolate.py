...
def get_pixel_value(img, x, y):
	...
	indices = tf.stack([b, y, x], 3, name='pixel_stack')
...
def affine_grid_generator(height, width, theta):
	...
	sampling_grid = tf.stack([x_t_flat, y_t_flat, ones], name='grid_stack')
  # sampling_grid -> (3, H*W)

	# repeat grid num_batch times
	sampling_grid = tf.expand_dims(sampling_grid, axis=0)
  # sampling_grid -> (1, 3, H*W)
	sampling_grid = tf.tile(sampling_grid, tf.stack([num_batch, 1, 1], name='tile_stack'))
  # sampling_grid -> (num_batch, 3, H*W)
